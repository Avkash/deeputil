...
"""
As-it-is
Taken directly from : https://raw.githubusercontent.com/rcmalli/keras-vggface/master/vggface/vggface.py

** INFO **
https://github.com/rcmalli/keras-vggface/blob/master/setup.py
setup(name='vggface',
      version='0.3',
