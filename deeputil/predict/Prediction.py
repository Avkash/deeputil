...
def perform_image_classification_by_model(model, input_image, is_image_array = False, top_n_classes=5):
    """
    ...
    if class_count == 0:
        print("Error: There was some prolem reading imagenet classes...")
        return results
    ...
    print("Generating predition dataframe now...")
    for pred in preds:
